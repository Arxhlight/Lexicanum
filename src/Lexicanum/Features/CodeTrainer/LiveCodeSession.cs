...
public class LiveCodeSession
{
    ...
    private static void ShowComparison(string leftTitle, string leftCode, string rightTitle, string rightCode)
    {
        var leftLines = leftCode.Split(LineSeparators, StringSplitOptions.RemoveEmptyEntries);
        var rightLines = rightCode.Split(LineSeparators, StringSplitOptions.RemoveEmptyEntries);
